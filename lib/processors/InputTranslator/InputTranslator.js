...
class InputTranslator {
    ...
    processView(loadedNodes, loadedRelationships, currentModelFolder, view, processViewDataEnable) {
        try {
            ...
            if (processViewDataEnable) {
                ...
                this.processViewElements(view, nodes, relationships, viewElements, bounds, null);
     ...
     */
    processViewElements(view, nodesResult, relationshipsResult, viewElements, bounds, parent, parentViewElements) {
    ...
    processViewRelationship(modelSourceNodeId, viewNodes, relationshipsResult, viewRelationship) {
        if (viewRelationship !== undefined) {
            ...
            if (sourceElement !== undefined && targetElement !== undefined) { // Verifying orphan relationship
                ...
                if (rel) { // There is an associated model relationship
                ...
                } else { // There is no model relationship associated, so it's a connection (only exists in the view)
