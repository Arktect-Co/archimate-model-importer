...
class InputTranslator {
        ...
        if (this.inputInterpreter.validate()) {
            ...
            if (!this.options.skipViews) {
                ...
                organizationFolders.forEach((organizationFolder) => {
                    this.processFolder(organizationFolder, this.outputModel.model.landscape, processViewDataEnable);
    ...
    processFolder(fileParentFolder, modelParentFolder, processViewDataEnable) {
        try {
            let currentModelFolder = this.outputModel.createFolder(getUniqueId(), this.inputInterpreter.getFolderName(fileParentFolder));
            let folders;
            let views;
